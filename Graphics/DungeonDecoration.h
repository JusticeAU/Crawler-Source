...
namespace Crawl
{
	...
	{
		j = { {"position", object.position }, {"facing", object.facing}, {"localPosition", object.localPosition }, {"localRotation", object.localRotation }, {"modelName", object.modelName } };
	...
	static void from_json(const ordered_json& j, DungeonDecoration& object)
	{
		...
		if (j.contains("localRotation")) j.at("localRotation").get_to(object.localRotation);
