...
void WindowResizeCallback(GLFWwindow* window, int width, int height)
{
	...
	auto fbList = TextureManager::FrameBuffers();					// Update texture resoluition of all framebuffers markeed as 'ScreenBuffers' - i.e. should be displayed directly to screen. keep them crisp.
	for (auto fb : *fbList)
	{
